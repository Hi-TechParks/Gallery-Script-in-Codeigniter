...
<div class="py-5">
    ...
    <?php if(count($objects["results"]) > 0){
          ...
          <div class="card " >
            <a href="<?php echo site_url('gallery/view_full/' . $gallery_id . '/' . $item->id)?>"><img class="card-img-top" src="<?=base_url('uploads/photos/' . $item->location);?>" width="100%" alt="<?=$item->name?>"></a>
          </div>
        </div>
                <?php 
              if($row_count == 4){
