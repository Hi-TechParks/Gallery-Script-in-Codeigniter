        ...
        <li class="active"><?=lang('admin_add_group')?></li>
            </ul>
          </div>
        </div>
        <div class="row">
...
echo form_open("admin/groups/create/", $attributes);
?>
              
                <div class="form-group">
                  <label for="name" class="col-sm-3 control-label"><?=lang('admin_name')?></label>
                  <div class="col-sm-5">
                    <input value="<?php echo set_value('name'); ?>" type="text" class="form-control" name="name" placeholder="<?=lang('admin_name')?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    ...
                    <?php foreach ($permissions['results'] as $permission) {
                      ?><option <?=select_multiple_option($this->input->post('permissions'), $permission->id)?> value="<?=$permission->id?>"><?=$permission->name?></option><?php
                    } ?>
                </select>
