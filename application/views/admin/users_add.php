        ...
        <li class="active"><?=lang('admin_add_user')?></li>
            </ul>
          </div>
        </div>
        <div class="row">
...
?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input value="<?php echo set_value('username'); ?>" type="text" class="form-control" name="username" placeholder="<?=lang('admin_username')?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input value="<?php echo set_value('email'); ?>" type="email" class="form-control" name="email" placeholder="<?=lang('admin_email')?>">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input value="<?php echo set_value('first_name'); ?>" type="text" class="form-control" name="first_name" placeholder="<?=lang('admin_first_name')?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input value="<?php echo set_value('last_name'); ?>" type="text" class="form-control" name="last_name" placeholder="<?=lang('admin_last_name')?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input <?=is_checked(set_value('is_active'))?> value="1" name="is_active" type="checkbox" data-toggle="toggle" data-on="<span class='glyphicon glyphicon-ok'></span> Yes" data-off="<span class='glyphicon glyphicon-remove'></span> No" data-onstyle="success" data-offstyle="default">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input <?=is_checked(set_value('is_staff'))?> value="1" name="is_staff" type="checkbox" data-toggle="toggle" data-on="<span class='glyphicon glyphicon-ok'></span> Yes" data-off="<span class='glyphicon glyphicon-remove'></span> No" data-onstyle="success" data-offstyle="default">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input <?=is_checked(set_value('is_superuser'))?> value="1" name="is_superuser" type="checkbox" data-toggle="toggle" data-on="<span class='glyphicon glyphicon-ok'></span> Yes" data-off="<span class='glyphicon glyphicon-remove'></span> No" data-onstyle="success" data-offstyle="default">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    ...
                    <?php foreach ($groups['results'] as $group) {
                      ?><option <?=select_multiple_option($this->input->post('groups'), $group->id)?> value="<?=$group->id?>"><?=$group->name?></option><?php
                    } ?>
                </select>
